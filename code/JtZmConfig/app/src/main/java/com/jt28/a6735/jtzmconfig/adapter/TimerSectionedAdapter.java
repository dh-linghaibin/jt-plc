...
public class TimerSectionedAdapter extends SectionedBaseAdapter {
    private Context mContext;

    private List<PlcTimer> leftStr;
    private List<List<Scenechild>> rightStr;

    public TimerSectionedAdapter(Context context, List<PlcTimer> leftStr, List<List<Scenechild>> rightStr) {
        this.mContext = context;
        this.leftStr = leftStr;
        this.rightStr = rightStr;
    }

    public void SetItem(List<PlcTimer> leftStr, List<List<Scenechild>> rightStr) {
        this.leftStr = leftStr;
        this.rightStr = rightStr;
    }
